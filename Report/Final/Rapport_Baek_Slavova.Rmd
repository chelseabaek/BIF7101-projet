...
Nous avons implémenté des versions plus récentes de certains outils disponibles sur T-REX, ainsi que des outils supplémentaires qui n'étaient pas inclus. Les performances des outils que nous avons implémentés ont été évaluées à l'aide de jeux de données de référence (BaliBASE) et comparées à celles des outils utilisés sur T-REX. Les résultats montrent une précision et une efficacité de calcul améliorées. 
